...
from app.schemas import CrowdEvent, EmergencyState, DecisionHistory
...
@pytest.mark.asyncio
async def test_engine_fallback_during_scram(sample_event, decision_history, emergency_state):
...
@pytest.mark.asyncio
async def test_engine_fallback_when_no_api_key_or_failure(sample_event, decision_history, emergency_state):
