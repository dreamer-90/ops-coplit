...
from app.schemas import ScramRequest, DispatchRequest
from app.services.operations import activate_scram_business_logic, recover_scram_business_logic, execute_dispatch_business_logic
...
async def request_dispatch(req: DispatchRequest) -> dict:
    ...
    if now - _dispatch_last_called < DISPATCH_RATE_LIMIT_SECONDS:
        raise HTTPException(status_code=429, detail="Rate limit exceeded. Please wait before dispatching again.")
